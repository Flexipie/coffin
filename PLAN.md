...
- **Next: Phase 5** (polish & ship: helpful errors, `--json`, completions, concealed clipboard, goreleaser, README/threat model). Manual macOS shakedown of `coffin run` Ctrl-C feel still pending (tests can't capture it).
